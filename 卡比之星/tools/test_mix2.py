...
# 第二批 12 組每一組都有貼身招（沒有純遠程型）
RANGED_ONLY = ()
BREATH = [('flamedragon', 'fire', 48), ('thunderdragon', 'spark', 48)]
KEEP = [
    ('thundergun', {'down': True, 'attack': True}, 18, [(70, 58, '↓X 電網（持續場地框）')]),
    ('timebeam', {'attack': True}, 12, [(110, 20, 'X 凍結光束（遠程光束）')]),
    ('timebeam', {'down': True, 'attack': True}, 18, [(66, 42, '↓X 時砂沙漏（持續場地框）')]),
    ('flamebow', {'down': True, 'attack': True}, 22, [(18, 46, '↓X 地火箭列（持續火柱）')]),
]
HELPER_KEY = 'thundersword'
